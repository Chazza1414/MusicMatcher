...
describe('Song e2e test', () => {
  ...
  const songSample = { artist: 'neural Paradigm', title: 'South Motorway' };
  ...
  describe('new Song page', () => {
    ...
    it('should create an instance of Song', () => {
      cy.get(`[data-cy="artist"]`).type('software back-end').should('have.value', 'software back-end');

      cy.get(`[data-cy="title"]`).type('Coordinator bypassing').should('have.value', 'Coordinator bypassing');
